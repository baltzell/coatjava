...
public class AdaptiveSwimmer {
	...
	private void straightLine(final double xo, final double yo, final double zo, final double momentum, double theta,
			double phi, final double sf, AdaptiveSwimResult result) {
		result.setFinalS(sf);
		result.setNStep(2);
	 ...
	 */
	public void swim(final int charge, final double xo, final double yo, final double zo, final double momentum,
			double theta, double phi, final double sf, final double h0, final double eps, AdaptiveSwimResult result)
			throws AdaptiveSwimException {
	...
	/**
	 * Swim to a definite pathlength. If extreme accuracy is not needed, use swim
	 * instead.
	 * 
	 * @param charge   in integer units of e
	 * @param xo       the x vertex position in meters
	 ...
	 * @throws AdaptiveSwimException
	 */
	public void swimS(final int charge, final double xo, final double yo, final double zo, final double momentum,
			double theta, double phi, final double accuracy, final double sf, final double h0, final double eps,
	 ...
	 * @throws AdaptiveSwimException
	 */
	public void sectorSwimZ(final int sector, final int charge, final double xo, final double yo, final double zo,
			final double momentum, double theta, double phi, final double targetZ, final double accuracy,
	 ...
	 * @throws AdaptiveSwimException
	 */
	public void swimZ(final int charge, final double xo, final double yo, final double zo, final double momentum,
			double theta, double phi, final double targetZ, final double accuracy, final double sf, final double h0,
			final double eps, AdaptiveSwimResult result) throws AdaptiveSwimException {
	 ...
	 * @throws AdaptiveSwimException
	 */
	public void swimRho(final int charge, final double xo, final double yo, final double zo, final double momentum,
			double theta, double phi, final double targetRho, final double accuracy, final double sf, final double h0,
			final double eps, AdaptiveSwimResult result) throws AdaptiveSwimException {
	 ...
	 * @throws AdaptiveSwimException
	 */
	public void swimPlane(final int charge, final double xo, final double yo, final double zo, final double momentum,
			double theta, double phi, Plane targetPlane, final double accuracy, final double sf, final double h0,
			final double eps, AdaptiveSwimResult result) throws AdaptiveSwimException {
		...
		while (count < MAXTRIES) {
			...
			// if we exceeded max path length, we are done
			if ((stopper.getS()) > stopper.getSmax()) {
				break;
			}
	 ...
	 * @throws AdaptiveSwimException
	 */
	public void swimPlaneInterp(final int charge, final double xo, final double yo, final double zo,
			final double momentum, double theta, double phi, Plane targetPlane, final double accuracy, final double sf,
			final double h0, final double eps, AdaptiveSwimResult result) throws AdaptiveSwimException {
		...
		AdaptivePlaneInterpStopper stopper = new AdaptivePlaneInterpStopper(uf, sf, targetPlane, accuracy,
				result.getTrajectory(), intersection);
		...
		while (count < MAXTRIES) {
			...
			// get the distance to the plane
			del = Math.abs(targetPlane.distance(stopper.getU()));
	 ...
	 * @throws AdaptiveSwimException
	 */
	public void swimSphere(final int charge, final double xo, final double yo, final double zo, final double momentum,
			double theta, double phi, Sphere targetSphere, final double accuracy, final double sf, final double h0,
			final double eps, AdaptiveSwimResult result) throws AdaptiveSwimException {
		...
		// pathlength reaches sf
		AdaptiveSphereStopper stopper = new AdaptiveSphereStopper(uf, sf, targetSphere, accuracy,
	 ...
	 * @throws AdaptiveSwimException
	 */
	public void swimCylinder(final int charge, final double xo, final double yo, final double zo, final double momentum,
			double theta, double phi, Cylinder targetCylinder, final double accuracy, final double sf, final double h0,
			final double eps, AdaptiveSwimResult result) throws AdaptiveSwimException {
		...
		// the stopper will stop if we come within range of the target cylinder or the
		// pathlength reaches sf
		AdaptiveCylinderStopper stopper = new AdaptiveCylinderStopper(uf, sf, targetCylinder, accuracy,
				result.getTrajectory());
	 ...
	 * @throws AdaptiveSwimException
	 */
	public void swimLine(final int charge, final double xo, final double yo, final double zo, final double momentum,
			double theta, double phi, Line targetLine, final double accuracy, final double sf, final double h0,
			final double eps, AdaptiveSwimResult result) throws AdaptiveSwimException {
	...
	private double[] init(final int charge, final double xo, final double yo, final double zo, final double momentum,
			double theta, double phi, AdaptiveSwimResult result) {
	...
	private void stuffU(double[] u, final double xo, final double yo, final double zo, final double momentum,
